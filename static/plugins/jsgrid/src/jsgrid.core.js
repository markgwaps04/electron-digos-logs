(function (window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        refresh: function () {
            ...
            if (this.pageLoading && this.autoload) {

                root
                    .controller
                    .loadData()
                    .then(function (response) {
                        root._refreshContent(response);
                        root._refreshPager();
                        root._refreshSize();
                        root._callEventHandler(root.onRefreshed);
                    });
            ...
            this._refreshContent(this.data);
            this._refreshPager();
            this._refreshSize();
